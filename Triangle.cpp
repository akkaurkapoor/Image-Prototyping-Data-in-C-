 ...
 * abpreetk
 *
 * Implemented triangle class functions for CoolPics below.
 */
...
// Default constructor sets three vertices to 0 & three colors to single color
Triangle::Triangle() {
    vertexOne.setX(0);
    vertexOne.setY(0);
...
// Overloaded constructor sets three vertices & colors to single color
...
// Overloaded constructor sets three vertices and colors to three colors
...
// Sets all three colors of triangle
...
// Sets all three vertices of triangle
...
// Returns all three vertices of triangle
...
// Sets color of all three vertices
...
// Returns color of all three triangle vertices
...
// Read triangle in proper form (vertex, color)
void Triangle::read(istream& ins) {
    ...
    // Reads in vertex then color
    ins >> newV1 >> newC1;
    
    setVertexOne(newV1);
    // If ins in fail state, clears, and reads in & sets vertices & color
    if (ins.fail()) {
        ins.clear();
    ...
    // Otherwise reads in & sets vertices and colors
...
// Writes triangle in proper form (vertex, color)
